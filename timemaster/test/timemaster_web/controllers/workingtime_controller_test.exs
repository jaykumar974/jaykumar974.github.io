defmodule TimemasterWeb.WorkingtimeControllerTest do
  ...
  @update_attrs %{
    start: ~U[2023-10-23 16:40:00Z],
    end: ~U[2023-10-23 16:40:00Z]
  }
  ...
  describe "create workingtime" do
    test "renders workingtime when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2023-10-22T16:40:00Z",
               "start" => "2023-10-22T16:40:00Z"
  ...
  describe "update workingtime" do
    ...
    test "renders workingtime when data is valid", %{conn: conn, workingtime: %Workingtime{id: id} = workingtime} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2023-10-23T16:40:00Z",
               "start" => "2023-10-23T16:40:00Z"
             } = json_response(conn, 200)["data"]
    end
